...
<div class="container-fluid p-4 view dashboard-view">
  <div class="row">
    ...
    <div class="col-md-2">
      <div class="card"><div class="card-body">
          <p class="m-b-0 text-warning">${parentHeading} Warning</p>
          <h3>${report.stats.parent?api.get(Status.WARNING)?c}</h3>
      </div></div>
    </div>
    <div class="col-md-2">
      <div class="card"><div class="card-body">
      ...
      <div class="card">
        ...
        <div class="card-footer">
          ...
          <div>
            ...
            <b>${report.stats.parent?api.get(Status.SKIP)}</b> skipped, <b data-tooltip='${report.stats.parentPercentage?api.get(Status.WARNING)}%'>${report.stats.parent?api.get(Status.WARNING)}</b> warning
            </small>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-footer">
          ...
          <div>
            ...
            <b>${report.stats.child?api.get(Status.SKIP)}</b> skipped, <b data-tooltip='%'>${report.stats.child?api.get(Status.WARNING) + report.stats.child?api.get(Status.INFO)}</b> warning
            </small>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-footer">
          ...
          <div>
            ...
            <b>${report.stats.grandchild?api.get(Status.SKIP)}</b> skipped, <b data-tooltip='%'>${report.stats.grandchild?api.get(Status.WARNING) + report.stats.grandchild?api.get(Status.INFO)}</b> warning
            </small>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-md-12 author-container">
      <div class="card">
        ...
        <div class="card-body pb-0 pt-0"><table class="table table-sm table-bordered">
          <thead><tr class="bg-gray"><th>Name</th><th>Passed</th><th>Failed</th><th>Skipped</th><th>warning</th><th>Passed %</th></tr></thead>
          <tbody>
    ...
    <div class="col-lg-6 col-md-12 category-container">
      <div class="card">
        ...
        <div class="card-body pb-0 pt-0"><table class="table table-sm table-bordered">
          <thead><tr class="bg-gray"><th>Name</th><th>Passed</th><th>Failed</th><th>Skipped</th><th>warning</th><th>Passed %</th></tr></thead><tbody>
